...
struct HashEditor: View {
    ...
    var body: some View {
        ...
        .onChange(of: data) { oldValue, _ in
            updateCachedKeys()
        }
        ...
        .onChange(of: debouncedSearchText) { oldValue, _ in
            updateCachedKeys()
        }
        .onChange(of: keySortAscending) { oldValue, _ in
            updateCachedKeys()
        }
        .onChange(of: valueSortAscending) { oldValue, _ in
            updateCachedKeys()
        }
...
struct ListEditor: View {
    ...
    var body: some View {
        ...
        .onChange(of: list) { oldValue, _ in
            updateCachedList()
        }
        .onChange(of: searchText) { oldValue, newValue in
            Task { @MainActor in
        ...
        .onChange(of: indexSortAscending) { oldValue, _ in
            updateCachedList()
        }
        .onChange(of: valueSortAscending) { oldValue, _ in
            updateCachedList()
...
struct SetEditor: View {
    ...
    var body: some View {
        ...
        .onChange(of: items) { oldValue, _ in
            updateCachedItems()
        }
        .onChange(of: searchText) { oldValue, newValue in
            Task { @MainActor in
        ...
        .onChange(of: sortAscending) { oldValue, _ in
            updateCachedItems()
        }
        .sheet(item: $editingTarget) { target in
...
struct ZSetEditor: View {
    ...
    var body: some View {
        ...
        .onChange(of: items.count) { oldValue, newCount in
        ...
        .onChange(of: scoreSortAscending) { oldValue, _ in
            updateCachedItems()
        }
        .sheet(item: $editingTarget) { target in
